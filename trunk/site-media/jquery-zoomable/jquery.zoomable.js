  ...
  $.fn.zoomable = function (method) {
    return this.each(function (index, value) {
      ...
      zoomData.originalWidth = $(value).width();
  		$(value).css('position', 'relative').css('left', '-147px').css('top', -120).css('margin', '0'); //set these to change default position, default after left is '0'
		//IMPORTANT: positions in quotes NEED px on the end to be valid when DOCTYPE html is used
  		$(value).draggable();
